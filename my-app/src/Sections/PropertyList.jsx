          ...
          <div id='grid-box' className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
            {properties.map((item, index) => (
              ...
              >
                ...
                >
                  {/* You can add more content inside this div as needed */}
                ...
                <div className='px-6 py-3  flex flex-col justify-center items-start gap-2 w-full'>
                  ...
                  <div id='icons' className='flex justify-center items-start gap-4'>
                    <div className='flex justify-center items-center gap-2'>
                      <FaBath className='size-5 text-red-400'></FaBath>
                      <h1 className='dark:text-white'>{item.bathrooms}</h1>
                    </div>

                    <div className='flex justify-center items-center gap-2'>
                      <FaBed className='size-5 text-red-400'></FaBed>
                      <h1 className='dark:text-white'>{item.bedrooms}</h1>
                    </div>

                    <div className='flex justify-center items-center gap-2'>
                      <MdSpaceDashboard className='size-5 text-red-400'></MdSpaceDashboard>
                  ...
                  <div className='w-full h-[1px] bg-grey-200 mt-8'>
                    ...
                    <div id='ownerInfo' className='flex justify-between item-center w-full mt-0'>
                      <div className=' flex justify-center items-center gap-2'>
                        <FaUserCircle className='size-5 text-red-400'></FaUserCircle>
